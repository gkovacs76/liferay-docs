...
- **Application Tier:** Hosts @product-ver@ supported application servers like Tomcat,
...
- **Database Tier:** Hosts @product-ver@ supported database servers like MySQL,
...
different environments to be able to maintain the projects. @product@ uses the
